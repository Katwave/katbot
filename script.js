...
const possibleMessages = {
  clientMessage: [
    ...
    /really?/i,
    /im good/i,
    /i'm doing good and you?/i,
    /what are your hobbies?/i,
    /when were you born?/i,
    /what is your surname?/i,
    /how are you?/i,
    /what is your name?/i,
    /show me your picture/i,
    /haha/i,
    /im doing good and you?/i,
    /hey/i,
    /hi/i,
    /how are you doing?/i,
    /how is your day going?/i,
    /how old are you?/i,
    /when were you created?/i,
    /what is your purpose?/i,
    /what langueges can you speak?/i,
  ],
  robotMessage: [
...
sendButton.addEventListener("click", (e) => {
  ...
  for (i = 0; i <= possibleMessages.clientMessage.length; i++) {
    if (possibleMessages.clientMessage[i].test(input.value)) {
      ...
      liBibot.innerText =
        "I do not understand what you are trying to say, please speak english atleast.";
      messageList.append(liBibot);
      liBibot.setAttribute("class", "them");
    }
  }
